# NP-Hard-optimization-problem-solving
A project centered around an NP-Hard resource-constrained weapon selection problem with state-dependent scaling and 2 approaches to solve it:
 - using Gurobi Solver
